...
export function CtaBanner() {
  ...
  return (
    <section className="relative overflow-hidden bg-primary py-28">
      <div className="pointer-events-none absolute -top-24 start-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-white/10 blur-[100px]" />
      <div className="relative mx-auto max-w-[900px] px-6 text-center">
        <SplitReveal as="h2" type="words" className="text-4xl font-extrabold text-white lg:text-5xl">
          {t("title")}{" "}
          <span className="underline decoration-white/40 underline-offset-8">{t("highlight")}</span>{" "}
          {t("titleEnd")}
        </SplitReveal>
