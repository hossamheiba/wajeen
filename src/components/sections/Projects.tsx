    ...
    <section id="projects" className="bg-white py-24">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="flex items-end justify-between gap-6">
          ...
          <Link href="/projects" className="hidden text-sm font-semibold text-primary sm:block">
            {t("viewAll")} →
          </Link>
        </div>
        ...
        <Swiper
          ...
          className="!mt-12 [&_.swiper-button-next]:!text-primary [&_.swiper-button-prev]:!text-primary"
        >
          {items.map((item, i) => (
